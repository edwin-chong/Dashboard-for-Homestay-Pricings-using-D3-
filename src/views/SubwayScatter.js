...
export default function SubwayScatter(props) {
  ...
  return (
    <div className="pane">
      <div className="header">Subway Count vs Average Price</div>
